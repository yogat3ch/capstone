...
kableExtra::kable(format = "html") %>% kableExtra::kable_styling(bootstrap_options = "striped", full_width = T, position = "center", font_size = 14) %>%
...
- Self-report and no objective/physiological measures of stress
